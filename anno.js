...
Anno = (function() {
  ...
  Anno.prototype.overlayElem = function() {
    var _this = this;
    return $("<div class='anno-overlay " + this.overlayClassName + "'></div>").click(function(evt) {
...
AnnoButton = (function() {
  ...
  AnnoButton.prototype.buttonElem = function(anno) {
    var _this = this;
    return $("<button class='anno-btn'></button>").html(this.textFn(anno)).addClass(this.className).click(function(evt) {
